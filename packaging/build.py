...
portable = out / "LupleGit-0.5.0-Windows-x64.zip"
...
subprocess.run([str(csc), "/nologo", "/target:exe", "/platform:x64", "/win32manifest:" + str(source / "packaging/app.manifest"), "/reference:System.Core.dll", "/reference:System.IO.Compression.dll", "/reference:System.IO.Compression.FileSystem.dll", "/resource:" + str(portable) + ",luple.zip", "/out:" + str(out / "LupleGit-Setup-0.5.0.exe"), str(source / "packaging/Setup.cs")], check=True)
print(portable)
